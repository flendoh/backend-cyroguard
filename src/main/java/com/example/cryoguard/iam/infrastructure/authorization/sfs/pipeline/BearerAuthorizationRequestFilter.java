package com.example.cryoguard.iam.infrastructure.authorization.sfs.pipeline;

import com.example.cryoguard.iam.infrastructure.authorization.sfs.model.UsernamePasswordAuthenticationTokenBuilder;
import com.example.cryoguard.iam.infrastructure.tokens.jwt.BearerTokenService;
...
public class BearerAuthorizationRequestFilter extends OncePerRequestFilter {
    ...
    protected void doFilterInternal(@NonNull HttpServletRequest request, @NonNull HttpServletResponse response, @NonNull FilterChain filterChain) throws ServletException, IOException {
        ...
        if (path != null && (path.startsWith("/api/v1/auth") || path.startsWith("/api/v1/authentication"))) {
